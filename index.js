...
//     var {subject, createdBy, assignTo} = task
...
//     if (dict[input] == null || dict[input] == undefined)
//     {
...
//         do
//         {
//             input = Number(prompt('Enter product position'))
//         }
//         while (isNaN(input) || input < 1 || input > products.length)
    
//         let product = products[input - 1]
...
// //5.3
    // {
    //     let input = prompt('Enter your category').toLowerCase()
    //     // do
    //     // {
    //     //     input = prompt('Enter your category')
    //     // }
    //     // while (products[0].Category != input)
        
    //     let check = false
    //     products.forEach(product => {
    //         if (product.Category.toLowerCase() === input)
    //         {
    //             check = true
    //             console.log('----------')
    //             console.log('Name:', product.Name)
    ...
    //     if (check == false) alert('Cant find that category')
    // }
...
//         console.log('#' + index + '.', product.Name)
//         console.log('    Price:', product.Price)
//         console.log('    Prodviders:', ...product.Providers)
//     });
// }
...
// //6.1
//     {
//         console.log('Hi there, this is your learning task:')
//         for (let i = 0; i < tasks.length; i++)
//         {
//             console.log(''+ (i+1) + '.', tasks[i].Title)
...
// //6.2 -> 6.5
//     {
//         let ValidCommand = ['new', 'delete', 'update', 'complete']
...
//                 case 'new':
//                 {
//                     let title = prompt('Enter new task')
...
//         tasks.forEach(task => {
//             index ++
//             let isComplete = (task.Complete) ? 'x' : ' '
//             console.log('' + index + '. ' + '[' + isComplete + ']', task.Title)
//         });
//     }
}
